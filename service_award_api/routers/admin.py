...
#para retornar os usuários sem o password
...
#region Funções
# permissão para subir o arquivo excel
...
async def reset_password(user: user_dependency, db: db_dependency, user_id: int = Path(gt=0)):
	...
	hashed_password = bcrypt_context.hash(DEFAULT_PASSWORD) # setta a senha para essa padrão
